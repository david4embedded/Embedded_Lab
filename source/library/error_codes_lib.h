...
enum LibErrorCodes
{
   ...
   eLOCKABLE_INIT_FAILED           = ( eLIBRARY | 0x00000004 ),

   eSEMAPHORE_INIT_FAILED          = ( eLIBRARY | 0x00000005 ),
   eSEMAPHORE_NOT_INITIALIZED      = ( eLIBRARY | 0x00000006 ),
   eSEMAPHORE_GET_TIME_OUT         = ( eLIBRARY | 0x00000007 ),

   eCLI_NO_COMMAND                 = ( eLIBRARY | 0x00000008 ),
   eCLI_TOO_MANY_COMMANDS          = ( eLIBRARY | 0x00000009 ),

   eSERIAL_DEVICE_NOT_INITIALIZED  = ( eLIBRARY | 0x0000000A ),
   eSERIAL_DEVICE_SEND_ACTIVE      = ( eLIBRARY | 0x0000000B ),
   eSERIAL_DEVICE_TX_MSG_TOO_LONG  = ( eLIBRARY | 0x0000000C ),
   eSERIAL_DEVICE_NO_SEND_ACTIVE   = ( eLIBRARY | 0x0000000D ),
   eSERIAL_DEVICE_SEND_TIMEOUT     = ( eLIBRARY | 0x0000000E )
};
